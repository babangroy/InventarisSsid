...
<html>
<head>
    <title>Laporan Pemasangan Barang</title>
    <style>
        body { 
...
<body>
    <div class="header">
        <h1>Laporan Pemasangan Barang</h1>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">{{ $record->tujuan ?? '-' }}</td>
                <td class="text-center">
                    @if($record->tanggal_pasang)
                        {{ \Carbon\Carbon::parse($record->tanggal_pasang)->translatedFormat('l, d M Y') }}
                    @else
                        -
                    @endif
                </td>
